...
class Search {
  ...
  displayResults() {
    ...
    fetch('http://localhost:10008/wp-json/wp/v2/posts?search=' + this.searchInput.value).then(response => // Your code for handling the data you get from the API
    response.json()).then(data => alert(data[0].title.rendered));
  }

...
class Search {
  ...
  displayResults() {
    Promise.all([fetch(siteData.root_url + '/wp-json/wp/v2/posts?search=' + this.searchInput.value).then(resp => resp.json()), fetch(siteData.root_url + '/wp-json/wp/v2/pages?search=' + this.searchInput.value).then(resp => resp.json())]).then(console.log); // fetch(
    //   siteData.root_url +
